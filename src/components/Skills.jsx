...
//               }}
//             >
//               I build complete web applications from idea to deloyment, handing
//               both frontend and backend with clean, scalable code.
//             </p>
//           </div>
//           <div
...
//                     >
//                       <div
//                         className="h-1 rounded-b-full opacity-70 group-hover:w-full transition-all duration-500 w-1/3"
//                         style={{
//                           background:
//                             "linear-gradient(to right, #f97316, #f59e0b)",
//                         }}
    ...
    >
      <div className="container px-5 py-14 mx-auto">
        <div className="text-center mb-20" data-aos="fade-up">
          ...
          >
            I build complete web applications from idea to deployment, handling
            both frontend and backend with clean, scalable code.
          </p>
        </div>
